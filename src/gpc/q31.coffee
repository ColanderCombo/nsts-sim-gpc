...
#
# Reference: IBM-85-C67-001 sect.4.10 DIVIDE, sect.4.21 MULTIPLY

# Q31 fullword multiply: two signed 32-bit fractions to 64-bit fraction.
# Returns [hi, lo] as unsigned 32-bit values.
#
# Per spec (sect.4.21): "Both multiplier and multiplicand are 32-bit signed
...
#
# Per spec (sect.4.21, sect.4.22): halfword operands use bits 0-15 (upper half
...
#
# Per spec (sect.4.10): "The first operand is divided by the second operand.
